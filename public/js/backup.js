...
//     var res = alasql('SELECT INTO XLSX("check.xlsx",?) FROM ?',
//                      [opts,[data1,data2]]);
// }
    ...
    var tablesToExcel = (function () {
        ...
        return function (table, name, filename) {
            ...
            for (var k = 0; k < tables.length; ++k) {
                ...
                counters = "AMLDataTable" + k;
                cc = counters.toString();
                if (!tables[k].nodeType) exceltable = document.getElementById("AMLDataTable3");
...
////////////////////////////////////////////
					    ...
					    // $('.btnView').click(function(clientid){
					    // 	var myid = $(this).attr("id");
					    // 	var testid = $.ajax({
					    // 		type: 'post',
					    // 		url: '/clientid?id='+myid,
					    // 		data: {
					    // 			'_token': $('input[name=_token]').val(),
